...
class CreateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'extension:create {extension} {--namespace=}';
     ...
     * @var string
     */
    protected $description = 'Build a Laravel extension';
    ...
    public function handle(Filesystem $filesystem)
    {
        ...
        $this->extensionDir = config('extension.extension_dir');
